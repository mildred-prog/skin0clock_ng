"""
Django settings for skin0clock_ng project.
...
SECRET_KEY = 'django-insecure-3dq=_3(=%m5y1lcf-c(@3=a^9xb@u6by1n^+nivdvwz0!#kgk4'
...
ROOT_URLCONF = 'skin0clock_ng.urls'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'skin0clock-ng' 
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'skin0clock_ng@example.com'
else:
